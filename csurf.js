...
function csurf (options) {
  ...
  return function csrf (req, res, next) {
    ...
    req.csrfToken = function csrfToken () {
      ...
      if (token && sec === secret) {
        console.log(`*** cached token '${token} has been returned'`)
        return token
      }
      ...
      if (sec === undefined) {
        ...
        console.log(`*** create and set secret '${secret}' inside 'csrfToken()'`)
      }
      ...
      console.log(`*** create new token '${token}' with secret '${secret}'`)
      return token
    }
    ...
    if (!secret) {
      ...
      console.log(`*** create and set secret '${secret}' outside 'csrfToken()'`)
    }
